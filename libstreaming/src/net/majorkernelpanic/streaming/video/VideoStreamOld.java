 ...
 */
public abstract class VideoStreamOld extends MediaStream {
	...
	public VideoStreamOld(int camera) {
		super();
		setCamera(camera);
	}
	 ...
	 * You can get the current state of the flash with {@link VideoStreamOld#getFlashState()}.
	 */
